...
<body>
	<div class="register py-container ">
		...
		<div class="registerArea">
			...
			<div class="info">
				<form class="sui-form form-horizontal" action="{{url('login/registerdo')}}" method="post">
					@csrf
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" placeholder="请输入你的手机号" name="umber" class="input-xfat input-xlarge">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">邮箱</label>
						<div class="controls">
							<input type="text" placeholder="请输入你的邮箱" name="email" class="input-xfat input-xlarge">
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls btn-reg">
							<button class="sui-btn btn-block btn-xlarge btn-danger" target="_blank">完成注册</button>
						</div>
					</div>
				</form>
