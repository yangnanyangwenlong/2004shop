...
<div class="register py-container ">
    ...
    <div class="registerArea">
        <h3>注册新用户<span class="go">我有账号，去<a href="{{url('login/login')}}">登陆</a></span></h3>
        <div class="info">
            ...
            @endif
            <form class="sui-form form-horizontal" method="post" action="{{url('login/registerDo')}}">
                @csrf
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="password" placeholder="设置登录密码" name="user_password" class="input-xfat input-xlarge">
                    </div>
                </div>
                <div class="control-group">
                    <label for="inputPassword" class="control-label">确认密码：</label>
                    <div class="controls">
                        <input type="password" placeholder="再次确认密码" name="user_password_confirmation" class="input-xfat input-xlarge">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" placeholder="请输入你的手机号" name="user_tel" class="input-xfat input-xlarge">
                    </div>
                </div>
