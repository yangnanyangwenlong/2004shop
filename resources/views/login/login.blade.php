                    ...
                    <div id="profile" class="tab-pane  active">
                        ...
                        <form class="sui-form" method="post" action="{{url('login/loginDo')}}">
                            ...
                            <div class="input-prepend"><span class="add-on loginname"></span>
                                <input id="prependedInput" type="text" placeholder="邮箱/用户名/手机号" name="user_account" class="span2 input-xfat">
                            </div>
                            {{$errors->first('user_account')}}
                            <div class="input-prepend"><span class="add-on loginpwd"></span>
                                <input id="prependedInput" type="password" placeholder="请输入密码" name="user_password" class="span2 input-xfat">
                            </div>
...
{{--                                    <input name="m1" type="checkbox" value="2" checked="">--}}
                                ...
                                <a href="https://github.com/login/oauth/authorize?client_id=e44913cb5699cc401521">使用github登录</a>
                            </div>
                            <div class="logined">
{{--                                <a class="sui-btn btn-block btn-xlarge btn-danger" href="home-index.html" >登&nbsp;&nbsp;录</a>--}}
                        ...
                        <div class="otherlogin">
                            ...
                            <span class="register"><a href="{{url('login/register')}}">立即注册</a></span>
                        </div>
                    </div>
                </div>
            </div>
