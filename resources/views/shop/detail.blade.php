...
<head>
    ...
    <title>产品详情页</title>
    <link rel="icon" href="/static/assets//static/img/favicon.ico">
                    ...
                    <div class="summary-wrap">
                        <div class="fl title">
                            <div class="control-group">
                                <div class="controls">
                                    ...
                                    <a href="javascript:void(0)" class="increment_plus plus">+</a>
                                    <a href="javascript:void(0)" class="increment_mins mins">-</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <script>
                            $(document).ready(function () {
                                $(document).on("click",".increment_plus",function () {
                                    var _this = $(this);
                                    var _itxt = parseInt($(".itxt").val());
                                    $(".itxt").val(_itxt+1);
                                })
                                ...
                                $(document).on("click",".sui-btn",function () {
                                    var _this = $(this);
                                    var goods_id = {{$shop_detail['goods_id']}};
                                    var goods_count = $(".itxt").val();
                                    var _url = '/cart/add';
                                    $.ajax({
                                        url:_url,
                                        data:{goods_id:goods_id,goods_count:goods_count},
                                        type:'get',
                                        dataType: 'json',
                                    }).done(function (res) {
                                        if(res.error == 1){
                                            alert('购物车添加成功')
                                            window.location.href='/cart/success?goods_id='+goods_id;
                                        }else{
                                            if(res.error == 400001){
                                                alert(res.msg);
