...
<div class="success-cart">
    <div class="py-container ">
        ...
        <div class="goods">
            <div class="left-good">
                <div class="left-pic"><img src="{{$Cart->goods_img}}"></div>
                <div class="right-info">
                    <p class="title">{{$Cart->goods_name}}</p>
                    <p class="attr">{{$Cart->keywords}} 数量：{{$Cart->shop_count}}</p>
                </div>
            </div>
            <div class="right-gocart">
                <a href="#" class="sui-btn btn-xlarge">查看商品详情</a>
                <a href="{{url('cart')}}" class="sui-btn btn-xlarge btn-danger " target="_blank">去购物车结算 > </a>
            </div>
        </div>
    </div>
</div>
                        ...
                        <ul class="yui3-g">
                            <li class="yui3-u-1-4">
                                <div class="banner-item">
                                    <div class="p-img"><a href="#"><img src="/static/img/_/gocart01.jpg"></a></div>
        ...
        <ul class="yui3-g">
            <li  class="yui3-u-1-4">
                <div class="buy-list">
                    ...
                    <p>血战龙</p>
                    <div class="imgs">
                        <div class="ab-cover"><img src="/static/img/_/buy01.jpg"></div>
                        <div class="ab-list">
                            <ul>
                                <li><img src="/static/img/_/buy001.jpg"></li>
                                <li><img src="/static/img/_/buy002.jpg"></li>
                                <li><img src="/static/img/_/buy002.jpg"></li>
                            </ul>
                        </div>
                    </div>
