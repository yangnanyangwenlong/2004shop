...
<!-- 模拟数据 -->
                            ...
                            <ul class="goods-list yui3-g">
                                <li class="yui3-u-1-24" id="iii">
                                    <input type="checkbox" class="goods_child" name="" id="" value="" />
                                </li>
                                @if($v['is_show']==0)
	                                <li class="yui3-u-11-24">
	                                    <div class="good-item">
	                                        <div class="item-img"><img src="/static/img/goods.png" /></div>
	                                        <div class="item-msg" style="color:gray">{{$v['cart_name']}}</div>
	                                    </div>
	                                    <span class="ppt" style="color:red">(亲商品已下架~。~)</span>
	                                </li>
	                                <li class="yui3-u-1-8"><span class="price">{{$v['cart_price']}}</span></li>
	                                <li class="yui3-u-1-8">
                                ...
                                <li class="yui3-u-11-24">
                                    <div class="good-item">
                                        <div class="item-img"><img src="/static/img/goods.png" /></div>
                                        <div class="item-msg">{{$v['cart_name']}}</div>
                                    </div>
                                    
                            	 	@if($v['stock']<10 && $v['stock']>0)
                            			<span class="ppt" style="color:red">库存紧张</span>
                            		@endif
                                </li>
                                ...
                                @endif
                                <li class="yui3-u-1-8"><span class="sum">{{$v['cart_price']}}</span></li>
                                <li class="yui3-u-1-8">
                                    <a href="#none">删除</a><br />
                                    <a href="#none">下订单</a>
                                </li>
